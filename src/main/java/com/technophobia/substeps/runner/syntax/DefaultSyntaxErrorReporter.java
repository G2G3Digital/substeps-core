...
public class DefaultSyntaxErrorReporter implements SyntaxErrorReporter {
    ...
    public void reportFeatureError(final File file, final int lineNumber, final String description)
        ...
        LOG.error("Error on line " + lineNumber + " of feature file " + file.getAbsolutePath() + ": " + description);
    }
    ...
    public void reportSubstepsError(final File file, final int lineNumber, final String description)
            throws RuntimeException {
        LOG.error("Error on line " + lineNumber + " of substeps file " + file.getAbsolutePath() + ": " + description);
    }
