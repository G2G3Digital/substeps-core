 ...
 * 
 */
public class BeforeAndAftersTest extends BeforeAndAftersTestParent {
	private static final Logger log = LoggerFactory.getLogger(BeforeAndAftersTest.class);
	...
	// this class
	@Ignore("static methods no longer supported")
	@Test
